...
to.angle_speed = angle_speed
to.angle_speed_israndom = angle_speed_israndom
to.angle_speed_random_min = angle_speed_random_min
to.angle_speed_random_max = angle_speed_random_max
to.angle_speed_add = angle_speed_add
to.angle_speed_add_israndom = angle_speed_add_israndom
to.angle_speed_add_random_min = angle_speed_add_random_min
to.angle_speed_add_random_max = angle_speed_add_random_max
to.angle_speed_mul = angle_speed_mul
to.angle_speed_mul_israndom = angle_speed_mul_israndom
to.angle_speed_mul_random_min = angle_speed_mul_random_min
to.angle_speed_mul_random_max = angle_speed_mul_random_max
