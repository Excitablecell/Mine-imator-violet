...
{
	// Save to movie
	buffer_poke(exportmovie_buffer,buffer_get_size(exportmovie_buffer)-1,buffer_u8,buffer_peek(exportmovie_buffer,buffer_get_size(exportmovie_buffer)-1,buffer_u8))
