...
if (id = mc_res)
{
	...
	buffer_poke(load_assets_block_preview_buffer,buffer_get_size(load_assets_block_preview_buffer)-1,buffer_u8,buffer_peek(load_assets_block_preview_buffer,buffer_get_size(load_assets_block_preview_buffer)-1,buffer_u8))
...
if (id = mc_res)
{
	...
	buffer_poke(load_assets_block_preview_ani_buffer,buffer_get_size(load_assets_block_preview_ani_buffer)-1,buffer_u8,buffer_peek(load_assets_block_preview_ani_buffer,buffer_get_size(load_assets_block_preview_ani_buffer)-1,buffer_u8))
...
buffer_poke(buffer_current,buffer_get_size(buffer_current)-1,buffer_u8,buffer_peek(buffer_current,buffer_get_size(buffer_current)-1,buffer_u8))
