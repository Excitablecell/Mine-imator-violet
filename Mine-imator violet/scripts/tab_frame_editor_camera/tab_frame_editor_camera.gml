...
var capwid, text;
capwid = max(text_caption_width("frameeditorcamerabladeamount"),text_caption_width("frameeditorcamerafov"));
...
{
	tab_control_meter()
	draw_meter("frameeditorcameraf", dx, dy, dw, tl_edit.value[e_value.CAM_F], 50, 1, 500, 230, 1, tab.camera.tbx_f, action_tl_frame_cam_f, capwid)
	tab_next()
}
...
if (tl_edit.value[e_value.CAM_COLOR_CORRECTION] && checkbox_expand_frameeditor_clrcor)
{
	...
	//tab_control_meter()
	//draw_meter("frameeditorcamerafogheight", dx, dy, dw, round(background_fog_start), 50, -300, 300, 0, 1, tab.camera.tbx_fog, action_tl_frame_cam_fog, capwid)
	//tab_next()
	
	//tab_control_meter()
	//draw_meter("frameeditorcamerafogheight", dx, dy, dw, tl_edit.value[e_value.CAM_FOG_HEIGHT], 50, -60, 0, -30, 1, tab.camera.tbx_fog, action_tl_frame_cam_fog, capwid)
	//tab_next()
...
//tab_control_checkbox()
//draw_checkbox("frameeditorcameratestshader", dx, dy, tl_edit.value[e_value.CAM_SIZE_KEEP_ASPECT_RATIO], action_tl_frame_cam_size_keep_aspect_ratio)
//tab_next()
