...
scale = ((draw_width * 0.33) / 1000) * setting_render_watermark_scale
watermark_x = 0
watermark_y = 0
watermark_width = sprite_get_width(setting_render_watermark_image)
watermark_height = sprite_get_height(setting_render_watermark_image)

gpu_set_texfilter(true)
//gpu_set_blendmode_ext(bm_one, bm_inv_src_alpha)

switch (setting_render_watermark_anchor_x)
{
	case "left":
...
switch (setting_render_watermark_anchor_y)
{
	case "top":
