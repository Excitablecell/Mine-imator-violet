...
with (properties)
{
	...
	with (project)
	{
		...
		tbx_bezier_y = new_textbox_ndecimals()
	...
	with (background)
	{
		...
		tbx_fog_height_start = new_textbox_integer()
		tbx_fog_height_end = new_textbox_integer()
		tbx_fog_height_density = new_textbox_integer()
		tbx_v_fog_bottom = new_textbox_integer()
		tbx_v_fog_top = new_textbox_integer()
		tbx_v_fog_wide = new_textbox_integer()
		tbx_v_fog_threshold = new_textbox_integer()
		tbx_v_fog_size = new_textbox_integer()
		tbx_v_fog_density = new_textbox_ndecimals()
		tbx_v_fog_pos_x = new_textbox_ninteger()
		tbx_v_fog_pos_y = new_textbox_ninteger()
		tbx_v_fog_pos_z = new_textbox_ninteger()
		tbx_fog_off_x = new_textbox_ninteger()
		tbx_fog_off_y = new_textbox_ninteger()
		tbx_fog_off_z = new_textbox_ninteger()
		//tbx_fog_height_density.suffix = "%"
...
with (frame_editor)
{
	...
	with(keyframe)
	{
		tbx_bezier = new_textbox_ndecimals()
		tbx_bezier_y = new_textbox_ndecimals()
		tbx_bezier_2x = new_textbox_ndecimals()
		tbx_bezier_2y = new_textbox_ndecimals()
	}
}
