...
transition_texture_map = new_transition_texture_map(65, 65, 12, 0)
transition_texture_small_map = new_transition_texture_map(36, 36, 2, 0)
log("Transitions OK")
...
if(os_get_language() == "fr"){
	language_load(languages_directory + "french.milanguage", language_english_map)
}
else if(os_get_language() == "zh"){
	language_load(languages_directory + "chinese.milanguage", language_english_map)
}
else{
	language_load(languages_directory + "english.milanguage", language_english_map)
}
