...
setting_view_real_time_render_time = 10000

font_main = font_add_lib(data_directory + "violet.ttf", 10, false, false)
font_main_bold = font_add_lib(data_directory + "violet.ttf", 10, false, false)
font_main_big = font_add_lib(data_directory + "violet.ttf", 16, false, false)
...
if(os_get_language() == "fr"){
	setting_language_filename = languages_directory + "french.milanguage"
}
else if(os_get_language() == "zh"){
	setting_language_filename = languages_directory + "chinese.milanguage"
}
else{
	setting_language_filename = languages_directory + "english.milanguage"
}
