...
switch (function)
{
	...
	case "easebezier":
	{
		...
		if(variable_instance_get(self, "keyframe_current") == undefined){
			return bezier_generate(xx, 0, 0, 1, 1);
		}
		return bezier_generate(xx,
		keyframe_current.value[e_value.BEZIER], 
		keyframe_current.value[e_value.BEZIERY], 
		keyframe_current.value[e_value.BEZIER2X], 
		keyframe_current.value[e_value.BEZIER2Y])	}
}
return xx
