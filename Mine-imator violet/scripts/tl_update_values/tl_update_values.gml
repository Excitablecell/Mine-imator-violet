...
tl_update_values_ease(e_value.BEZIERY, "instant", 0)
tl_update_values_ease(e_value.BEZIER2X, "instant", 0)
tl_update_values_ease(e_value.BEZIER2Y, "instant", 0)
...
if (value_type[e_value_type.CAMERA])
{
	...
	tl_update_values_ease(e_value.CAM_FOG_HEIGHT, trans, p)
	tl_update_values_ease(e_value.CAM_FOG_HEIGHT_END, trans, p)
	...
	tl_update_values_ease(e_value.CAM_F_ENABLE, "instant", 0)
}
...
if (value_type[e_value_type.BACKGROUND])
{
	...
	tl_update_values_ease(e_value.BG_FOG_START, trans, p)
	...
	tl_update_values_ease(e_value.NOISETHRESHOLD, trans, p)
	tl_update_values_ease(e_value.VFOGBOTTOM, trans, p)
	tl_update_values_ease(e_value.VFOGTOP, trans, p)
	tl_update_values_ease(e_value.VFOGWIDE, trans, p)
	tl_update_values_ease(e_value.VFOGSIZE, trans, p)
	...
	tl_update_values_ease(e_value.VFOG_DENSITY,trans, p)
	tl_update_values_ease(e_value.VFOG_POS_X,trans, p)
	tl_update_values_ease(e_value.VFOG_POS_Y,trans, p)
	tl_update_values_ease(e_value.VFOG_POS_Z,trans, p)
	tl_update_values_ease(e_value.FOG_OFF_X,trans, p)
	tl_update_values_ease(e_value.FOG_OFF_Y,trans, p)
	tl_update_values_ease(e_value.FOG_OFF_Z,trans, p)
}
